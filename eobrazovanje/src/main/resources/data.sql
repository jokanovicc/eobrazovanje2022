...
insert into performance_exam(performance_id, date, classroom, exam_period_id, status) values ( 4, '2022-05-11', '314', 3, 'UNRATED');
insert into performance_exam(performance_id, date, classroom, exam_period_id, status) values ( 5, '2022-05-14', '315', 3, 'UNRATED');
